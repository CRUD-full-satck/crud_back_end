...
const clientLoginService = ({ email, password, }) => __awaiter(void 0, void 0, void 0, function* () {
    const clientRepository = data_source_1.default.getRepository(client_entitie_1.Client);
    const client = yield clientRepository.findOneBy({ email });
    if (!client)
        throw new errors_1.AppError("Email or Password invalid", 403);
    const validatePassword = yield (0, bcryptjs_1.compare)(password, client.password);
    if (!validatePassword)
        throw new errors_1.AppError("Email or Password invalid", 403);
